...
import com.huyistudio.util.FileStringWriter;
import com.huyistudio.util.FileUtils;
import com.huyistudio.util.SeparatorUtils;

public class VttTxtDownloader extends TxtDownloader {

    private static final String TAG = VttTxtDownloader.class.getSimpleName();

    private FileStringWriter fileStringWriter = null;

    public VttTxtDownloader(String location, String filePath, String saveDirPath) {
